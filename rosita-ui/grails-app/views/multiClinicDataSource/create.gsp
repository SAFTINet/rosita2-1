    ...
    <body>
        ...
        <div class="body">
            ...
            <g:form action="save" >
                ...
                <div class="bottombar">
					...
					<div class="bigbutton">
						<span onclick="checkForName();" class="save bigbuttoninput" >Create</span>
						<g:actionSubmit id="createBtn" action="save" style="visibility:hidden;" value="Create" />
					</div>
				</div>
            </g:form>
        </div>
        <g:javascript>
			...
			function checkForName() {  
				...
				{
					if(checkFlag){
						$j('#createBtn').css("visibility", "visible");
						$j("#createBtn").trigger("click");
						$j('#createBtn').css("visibility", "hidden");
					}
				}
			}
