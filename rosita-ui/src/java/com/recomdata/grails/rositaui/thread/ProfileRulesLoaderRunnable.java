...
public class ProfileRulesLoaderRunnable extends AbstractStepRunnable {

	String filename = "";
	
	public Integer getWorkflowStep() { return 18; }
	...
	public String[] getProcessParams() {
		return new String[] {scriptDir+"rosita"+(getUnix()?".sh":".bat"), "loadprofilerules", "jobid=0", "stepid="+stepId.toString(), "forui"};
	}
