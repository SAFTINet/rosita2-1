...
public class OmopVocabularyLoaderRunnable extends AbstractStepRunnable {

	String filename = "";
	
	public Integer getWorkflowStep() { return 17; }
	public String getCommandName() { return "loadomopvocabulary"; }
	...
	public String[] getProcessParams() {
		return new String[] {scriptDir+"loadomopvocabulary"+(getUnix()?".sh":".bat"), stepId.toString()};
	}
